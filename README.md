...
P.S: readme в большей части писал 11 числа, также сегодня убрал немного мусора из кода (ненужные импорты, события на нажатия клавиши(постановка башни,выход из всей игры,убирание меню выбора башен), удобные для меня когда тестировал игру) и т.д. Мусора и лишних строк по прежнему много, ведь код писался до самих 12 часов 10 декабря.
